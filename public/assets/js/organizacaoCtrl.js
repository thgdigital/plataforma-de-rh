angular.module("app").controller("OrganizacaoCtrl", function($scope, OrganizacaoAPI, UserAPI,$location){
    $scope.organizacoes = [];
var dados ={
    "estados": [
        {
    ...
    $scope.estados = dados.estados;
    $scope.getEstado = function(){
        console.log($scope.organizacoes.estado);
    };
    $scope.atualizarEmpresa = function(empresa) {

        OrganizacaoAPI.saveOrganizacao(empresa).success(function (data) {
    ...
    OrganizacaoAPI.getByOrganizacao().success(function(data){
